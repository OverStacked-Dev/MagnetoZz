...
local trackerPlaceholderEnabled = false
...
local trackerToggleBtn = makeActionButton(espSection, "Tracker ESP OFF WIP", 12, 84, 184, THEME.danger)
local trackerStatus = makeStatusLabel(espSection, 210, 92, 300)
trackerStatus.Text = "Placeholder only. Tracker ESP is not active yet."
local espInfo = makeStatusLabel(espSection, 12, 132, 450)
...
rebuildPartColorList = function()
    ...
    for partName, color in pairs(CONFIG.partColors) do
        ...
        local nameLabel = makeStatusLabel(row, 8, 6, 170)
...
connect(trackerToggleBtn.MouseButton1Click, function()
    trackerPlaceholderEnabled = not trackerPlaceholderEnabled
    trackerToggleBtn.Text = trackerPlaceholderEnabled and "Tracker ESP ON WIP" or "Tracker ESP OFF WIP"
    trackerToggleBtn.BackgroundColor3 = trackerPlaceholderEnabled and THEME.success or THEME.danger
